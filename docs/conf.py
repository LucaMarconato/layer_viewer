...
# -*- coding: utf-8 -*-
#
# layer_viewer documentation build configuration file, created by
...
sphinx_gallery_conf = {
    'doc_module': ('layer_viewer',),
    # path to your examples scripts
    'examples_dirs': '../examples',
    # path where to save gallery generated examples
    'gallery_dirs': 'auto_examples',
    'backreferences_dir': 'api',
    'reference_url': {'layer_viewer': None},
}
...
version = layer_viewer.__version__
# The full version, including alpha/beta/rc tags.
release = layer_viewer.__version__
...
htmlhelp_basename = 'layer_viewerdoc'
...
latex_documents = [
    (master_doc, 'layer_viewer.tex',
     u'layer_viewer Documentation',
